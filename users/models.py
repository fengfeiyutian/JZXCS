...
class User(AbstractUser):
    ...
    job_time = models.CharField(max_length=10, default='0001')  #工作证号

#    zhengzhi_mianmao = models.CharField(max_length=10, default='群众')    #政治面貌
#    zhengzhi_time = models.CharField(max_length=20, default='2010-10-31')   #6为数字，入党、团时间

#    job = models.CharField(max_length=30, default='工程师')           #职称
#    job_time = models.CharField(max_length=20, default='2018-02-23')    #6为数字，获得职称时间

#    job_2 = models.CharField(max_length=30, default='员工')   #职务
#    id_number = models.CharField(max_length=30, default='110108199912166982')   #身份证号

#    xue_li = models.CharField(max_length=30, default='本科')  #学历
#    school = models.CharField(max_length=30,default='北京理工大学')   #学校
#    gradute_time = models.CharField(max_length=20, default='2000-10-10')    #毕业时间
#    job_join_time = models.CharField(max_length=20, default='2000-10-10')   #入职时间
#    team_belong = models.CharField(max_length=20, default='C640')   #所属部门

#    phone = models.CharField(max_length=30, default='13838384963')   #手机号
